...
Here is an example image from the s3 with the final result.  For Roboflow, we only sent the image if the dog was identified as sitting.  Images for this pipeline piece stop after image #29: https://dog-training-good-boiii.s3.us-west-1.amazonaws.com/dog-28.jpg
