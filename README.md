...
Here is an example of an image from the yolov5 model pipeline. For this, we also tried to send images of only "sit": https://dog-training-good-boiii.s3.us-west-1.amazonaws.com/dog-149.jpg
